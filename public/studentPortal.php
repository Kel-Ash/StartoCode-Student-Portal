<?php
// Start the session if it hasn't been started yet in formProcessor.php
...
// If the form processor successfully processed the data and redirected here with a success session
if (isset($_SESSION['success'])): ?>
    <div id="success-popup" class="success-popup">
        <span class="popup-icon">✓</span>
        <span class="popup-text"><?php echo $_SESSION['success']; ?></span>
    </div>
    <?php unset($_SESSION['success']); ?>

    <script>
        // Hold the message for 3 seconds, then move to the records page
        setTimeout(function() {
            ...
            <div class="grid-container">
                ...
                <div class="form-group radio-group">
                    <div class="option">
                        ...
                        <input type="radio" name="gender" id="user-gender-male" value="male">
                        <label for="female"> Female</label>
                        <input type="radio" name="gender" id="user-gender-female" value="female">
                    </div>
